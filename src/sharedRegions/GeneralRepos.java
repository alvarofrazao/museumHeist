 ...
 * 
 *    Variables that are but shouldnt be hardcoded: number of thieves, number of rooms, number of thieves in party, number of assault parties
 */
public class GeneralRepos {
   ...
   *  Master thief planning the Heist and the ordinaries are blocked on concentrarion area
   *  Internal operation.
   */
    private void logInit(){
        ...
        log.writelnString("MstT   Thief 1      Thief 2      Thief 3      Thief 4      Thief 5      Thief 6            Elem 1     Elem 2     Elem 3         Elem 1     Elem 2     Elem 3    Room 1  Room 2  Room 3  Room 4  Room 5");
        log.writelnString("Stat  Stat S MD    Stat S MD    Stat S MD    Stat S MD    Stat S MD    Stat S MD    RId  Id Pos Cv  Id Pos Cv  Id Pos Cv  RId  Id Pos Cv  Id Pos Cv  Id Pos Cv   NP DT   NP DT   NP DT   NP DT   NP DT");
        if (!log.close ()){
   ...
   *  The current state of all thieves, situation and max displacement of ordinary thieves is organized in a line to be printed.
   *  In another line print assault party related info (thieves, destination room, etc) and room information (current painting and distance from site)
   *  Internal operation.
   */
     ...
     * @param id id of ordinary thief 
     * @param state new state of ordinary thief's party 'W' for waiting and 'P' for in party
     */
    ...
    /**
     * Removes thief from an assault party. Replaces thief's id with 0 to indicate empty space
    ...
    /**
     * Updates thief's position and returns, or ends program if thief isnt in specified assault party details.
    ...
    /**
     * Updates thief's canvas status and returns or ends program if thief isnt in specified assault party details
     * @param ap assault party id
