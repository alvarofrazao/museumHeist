...
sshpass -f password ssh sd206@l040101-ws06.ua.pt 'fuser -k 22258/tcp'

sshpass -f password ssh sd206@l040101-ws06.ua.pt 'mkdir -p test/museumHeist'
sshpass -f password ssh sd206@l040101-ws06.ua.pt 'rm -rf test/museumHeist/*'
sshpass -f password scp dirCCL.zip sd206@l040101-ws06.ua.pt:test/museumHeist
